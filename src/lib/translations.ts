...
export const translations = {
  ...
  ar: {
    ...
    hero: {
      ...
      subtitle: "حياك في استوديو بيلاتوبيا في حي النرجس في الرياض تعالي واكتشفي قوة وأثر البيلاتس. كل جلسة هي خطوة  لنسخة منك تحبينها أكثر",
    ...
    faq: {
      ...
      list: [
        ...
        },
        {
          ...
          answer: "البيلاتس مناسب لجميع الأعمار. ولكن في بيلاتوبيا نسعد بخدمة المشتركات من عمر ال16 عام وفوق",
        },
        {
          question: "متى تنتهي عروضكم؟",
          answer: "عرضنا الحالي هو خصم 10% على جميع الباقات. والعرض سارِ حتى يوم الأربعاء 31/12",
        },
        {
    ...
    // Footer
    footer: {
      tagline: "استوديو بيلاتس في حي النرجس، الرياض",
      studio: "الاستوديو",
      classes: "الكلاسات",
